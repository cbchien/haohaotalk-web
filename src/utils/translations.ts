...
export const translations: Record<Language, Translations> = {
  en: {
    ...
    chat: {
      ...
      turn: 'Turn',
      objectiveNotification: 'Recommended turns: {maxTurns}',
      begin: 'Begin',
  ...
  zh: {
    ...
    chat: {
      ...
      turn: '回合',
      objectiveNotification: '建議回合數：{maxTurns}',
      begin: '開始',
    ...
    performance: {
      ...
      connectionProgression: '連結強度變化',
      relativeToOthers: '與其他用戶比較',
      ...
      expressEmotionsDetail:
        '「我感覺時間被耽誤了，而我沒能掌握自己的安排，讓我感到有些被忽視。」',
      clarifyNeeds: '主動釐清自己的需求',
      clarifyNeedsDetail:
        '「如果你下次可能會遲到，我希望你可以提前告訴我，這樣我可以自己調整安排，也不會這麼緊張。」',
    ...
    conversion: {
      ...
      benefits: {
        secureProgress: {
          title: '保護您的進度',
          description: '保存對話記錄和練習成果',
        },
        fasterLogin: {
          title: '更快登入',
          description: '每次都能快速開始練習',
        },
        advancedInsights: {
          title: '進階分析',
          description: '獲得詳細的表現分析和個人化建議',
        },
      },
