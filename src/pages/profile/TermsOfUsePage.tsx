          ...
          {currentLanguage === 'zh' ? (
            <div className="space-y-4 text-gray-600">
              ...
              <section>
                ...
                <p>
                  歡迎使用好好說。使用我們的服務即表示您同意遵守以下條款和條件。
                </p>
              </section>
              ...
              <section>
                ...
                <p>
                  在法律允許的最大範圍內，我們對因使用本服務而產生的任何直接、間接、偶然或後果性損害不承擔責任。
                </p>
              </section>
              ...
              <section>
                ...
                <p>
                  我們保留隨時修改這些條款的權利。重大變更將透過應用程式通知您。
                </p>
              </section>
            </div>
          ) : (
            <div className="space-y-4 text-gray-600">
              ...
              <section>
                ...
                <p>
                  Welcome to HaoHaoTalk. By using our service, you agree to
              ...
              <section>
                ...
                <p className="mt-2">
                  is protected by intellectual property law and owned by
                  HaoHaoTalk or its licensors.
                </p>
              </section>
