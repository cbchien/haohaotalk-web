        ...
        <div className="prose prose-sm max-w-none">
          {currentLanguage === 'zh' ? (
            <div className="space-y-4 text-gray-600">
              <div>
                <h2 className="text-lg font-semibold text-gray-900 mb-3">隱私政策</h2>
                <p className="text-sm text-gray-500 mb-4">最後更新：2025年8月22日</p>
              </div>

              <section>
                <h3 className="text-base font-semibold text-gray-900 mb-2">資料收集</h3>
                <p>我們收集您主動提供的資訊，包括：</p>
              ...
              <section>
                <h3 className="text-base font-semibold text-gray-900 mb-2">資料使用</h3>
                <p>我們使用您的資料來：</p>
                <ul className="list-disc list-inside ml-4 mt-2">
                  <li>提供個人化的學習體驗</li>
                  <li>分析您的進步情況</li>
              ...
              <section>
                <h3 className="text-base font-semibold text-gray-900 mb-2">資料保護</h3>
              ...
              <section>
                <h3 className="text-base font-semibold text-gray-900 mb-2">您的權利</h3>
                <p>您有權：</p>
                <ul className="list-disc list-inside ml-4 mt-2">
                  <li>存取您的個人資料</li>
                  <li>更正不準確的資料</li>
              ...
              <section>
                <h3 className="text-base font-semibold text-gray-900 mb-2">聯絡我們</h3>
                <p>如果您對隱私政策有任何疑問，請透過應用程式內的「回報問題」功能聯絡我們。</p>
              </section>
            </div>
          ) : (
            <div className="space-y-4 text-gray-600">
              ...
              <section>
                ...
                <ul className="list-disc list-inside ml-4 mt-2">
                  <li>Account registration information (email, display name)</li>
              ...
              <section>
                <h3 className="text-base font-semibold text-gray-900 mb-2">Data Usage</h3>
              ...
              <section>
                <h3 className="text-base font-semibold text-gray-900 mb-2">Data Protection</h3>
              ...
              <section>
                <h3 className="text-base font-semibold text-gray-900 mb-2">Your Rights</h3>
              ...
              <section>
                ...
                <p>If you have any questions about this privacy policy, please contact us through the "Contact Us" feature in the app.</p>
              </section>
            </div>
          )}
        </div>
